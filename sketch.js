...
var generators = {
  ...
  // Cacti
  // Kanagawa:
  // Scorpion: [[[0,0],0,.1 .7,.24 .14,.38 .11,-.14 .22,-.15 .59,-.09 .4,-.17 .52,-.18 .64,-.17 .68,-0.09 .89-.19 .79 -0.08],[1,0]],6,20,1],
  // Baobob: [[[0,0],.18,0.03 .27,.17 .29,.49 .35,.17 .49,0.02 .66,-0.1],[1,0]],6,20,1],
  what: [
    [
      [0, 0],
      [-0.05, -0.19],
